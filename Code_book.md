...
The following data transformations were conducted to create a tidy dataset:
...
* A tidy data set with the average of each variable for each activity and each subject is created. 
